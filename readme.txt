...
<strong>Job Board Manager</strong> plugin created for manage job site easily. it allows you to create job board manager website within few minute without any complex setup, it has the different shortcode for displaying job archive, job submission, account, logged in user job list and more. job single page is optimized for SEO by following schema.org markup. this plugin has the variety of action and filter hook to extend functionality as needed.
...
* [Documentation](http://www.pickplugins.com/docs/documentation/job-board-manager/)
...
== Changelog ==
	...
	= 2.0.25 =
    * 21/08/2017 - remove - remove job option "Display company name?".
    * 21/08/2017 - remove - remove job option "Display company address?".
    * 21/08/2017 - remove - remove job option "Job status".
    * 21/08/2017 - remove - remove job option "Short content".
    * 21/08/2017 - remove - remove job option "Job responsibilities".
    * 21/08/2017 - remove - remove job option "Education requirements".
    * 21/08/2017 - remove - remove job option "Experience requirements".
    * 21/08/2017 - remove - remove job option "Skills requirements".
    * 21/08/2017 - remove - remove job option "Qualifications".
    * 21/08/2017 - remove - remove job option "Expiry date".
    * 21/08/2017 - remove - remove job option "Featured job".
