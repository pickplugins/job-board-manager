    ...
    <tr class="form-field">
      ...
      <td>
        ...
        <div   id="field-wrapper-<?php echo $id; ?>" class=" field-wrapper field-media-wrapper
          ...
          <div class='button upload' id='media_upload_<?php echo $id; ?>'><?php echo __('Upload','pickplugins-options-framework');?></div><div class='button clear' id='media_clear_<?php echo $id; ?>'><?php echo __('Clear','pickplugins-options-framework');?></div>
        ...
        <p class="description">Set the thumbnail</p>
      </td>
    </tr>
  <?php
