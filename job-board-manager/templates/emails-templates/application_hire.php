    ...
    <div style="background: #f5f5f5; color: #333; font-size: 14px; line-height: 20px; font-family: Arial, sans-serif;margin: 0 auto;">
        <div style="width: 600px; margin: 0 auto;">
            ...
            <div class="content" style="padding: 10px 0 40px;">
                <p style="font-size: 14px; line-height: 20px; color: #333; font-family: Arial, sans-serif;"><?php echo __('Congratulations! Your application hired.', 'job-board-manager'); ?></p>
                <table width="100%" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <p style="">
                                <a style="text-decoration: none; color: #51b3ff;font-size:15px;" href="{job_url}">Job: {job_title}</a>
                                <a style="text-decoration: none; color: #999;font-size:13px;" href="{application_url}">Application: #{application_id}</a>

                            </p>


                            <div style="padding: 10px 0 0;"><a class="btn" style="color: #fff; border-radius: 3px; text-decoration: none; background-color: #51b3ff; padding: 10px 20px; font-size: 14px; font-family: Arial, sans-serif;" href="{job_edit_url}"><?php __('View Application', 'job-board-manager'); ?></a></div>
                        </td>
                    </tr>
                    </tbody>
                </table>
