...
class JobBoardManager{
	...
	public function __construct(){
		...
		define('job_bm_plugin_version', '2.1.28' );
	...
	public function job_bm_activation() {
        ...
        add_role( 'job_seeker', __('Job Seeker', 'job-board-manager'),   array(
            'read' => true,
            'create_job' => true,
            'edit_job' => true,
            'delete_job' => true,
        ...
        add_role( 'job_poster', __('Job Poster', 'job-board-manager'),   array(
            'read' => true,
            'create_job' => true,
            'edit_job' => true,
            'delete_job' => true,
        ...
        add_role( 'job_manager', __('Job Manager', 'job-board-manager'), array(
            'read' => true,
            'create_job' => true,
            'edit_job' => true,
            'delete_job' => true,
