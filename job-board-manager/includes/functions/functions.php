...
function job_bm_filter_sidebar_sections($sections){
	...
	$apply_method_html['direct_email'] = '<div class="side-meta"><i class="fa fa-envelope-o"></i> '.__('Apply via email :','job-board-manager').'<a class="apply-job" href="mailto:'.$job_bm_contact_email.'?subject='.get_the_title().'">'.__('Send Email','job-board-manager').'</a></div>';
