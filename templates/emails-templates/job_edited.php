    ...
    <div style="background: #f5f5f5; color: #333; font-size: 14px; line-height: 20px; font-family: Arial, sans-serif;">
        <div style="width: 600px; margin: 0 auto;">
            ...
            <div class="content" style="padding: 10px 0 40px;">
                <p style="font-size: 14px; line-height: 20px; color: #333; font-family: Arial, sans-serif;"><?php echo sprintf(__('%s has edited job', 'job-board-manager'), '<b>{current_user_name}</b>'); ?></p>
...
$templates_data_html['job_edited'] = ob_get_clean();
