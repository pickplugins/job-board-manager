    ...
    <div style="background: #f5f5f5; color: #333; font-size: 14px; line-height: 20px; font-family: Arial, sans-serif;">
        <div style="width: 600px; margin: 0 auto;">
            ...
            <div class="content" style="padding: 10px 0 40px;">
                <p style="font-size: 14px; line-height: 20px; color: #333; font-family: Arial, sans-serif;"><?php echo sprintf(__('%s Your application removed from hire.', 'job-board-manager'), '<b>{current_user_name}</b>'); ?></p>
                <table width="100%" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            ...
                            <div style="padding: 10px 0 0;"><a class="btn" style="color: #fff; border-radius: 3px; text-decoration: none; background-color: #51b3ff; padding: 10px 20px; font-size: 14px; font-family: Arial, sans-serif;" href="{application_url}"><?php echo __('View Application', 'job-board-manager'); ?></a></div>
                        </td>
                    </tr>
                    </tbody>
                </table>
...
$templates_data_html['application_not_hire'] = ob_get_clean();
